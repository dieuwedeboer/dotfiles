...
;; 1. Find the controller (e.g. LPK25) input port by
;;    running `aconnect -i` (e.g. "128:0")
;; 2. Find the FluidSynth (or other) synthesizer output port by running `aconnect -o`
;;    (e.g. "24:0")
;; 3. Connect the devices with `aconnect <input-port> <output-port>`
