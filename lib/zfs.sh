...
# summary does not see it. Naming the step is household.sh's job, and so is
# anything a person has to be told about -- household_ksystemstats owns the
# zpool sensor for exactly that reason.
